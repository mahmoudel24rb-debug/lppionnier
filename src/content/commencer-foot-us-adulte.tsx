  ...
  return (
    <>
      ...
      <CtaQuiz
        ...
        texte="8 questions sur ta taille, ton explosivité et ton rapport au contact — notre algorithme de scouting, calibré sur les profils réels NFL et NCAA, te dit où tu serais le plus dangereux."
      ...
      <ul>
        ...
        <li><strong>Écris ou viens directement</strong> : un message suffit — « débutant complet, j'aimerais essayer ». La réponse sera toujours oui.</li>
