...
const FLAG_FR: Formule[] = [
  {
    ...
    price: '150 €',
    period: '/saison',
    desc: ['Équipe senior mixte, sans contact ·', 'nés en 2008 et avant.'],
  ...
  },
  {
    ...
    price: '100 €',
    period: '/saison',
    desc: ['U7 à U18 · nés de 2009 à 2021.'],
    features: [
...
const FLAG_EN: Formule[] = [
  {
    ...
    price: '€150',
    period: '/season',
    desc: ['Co-ed senior team, no contact ·', 'born in 2008 or earlier.'],
  ...
  },
  {
    ...
    price: '€100',
    period: '/season',
    desc: ['U7 to U18 · born 2009 to 2021.'],
    features: [
      'FFFA license included',
      'Certified coaching',
      'Discover flag football',
      'Youth league · U13 · U15 · U18',
