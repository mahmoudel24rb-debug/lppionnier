...
const T = {
  fr: {
    ...
    lead: "Depuis 1987, les Pionniers font vivre le football américain et le flag football à Tours : des athlètes qui se dépassent, un staff qui transmet, des bénévoles qui construisent. Sur le terrain ou à côté, chacun a sa place dans l'effectif.",
    reperes: [
  ...
  en: {
    ...
    lead: 'Since 1987, the Pionniers have kept American football and flag football alive in Tours: athletes pushing their limits, a staff passing the game on, volunteers building the club. On the field or beside it, everyone has a place on the roster.',
    reperes: [
      { label: '1987', txt: 'The club is founded in Tours: American football arrives in Touraine.' },
      { label: 'Two sports', txt: 'Full-contact American football, no-contact flag football: two disciplines, one intensity.' },
      { label: 'For everyone', txt: 'Seniors, U18 juniors and the flag academy: beginners welcome, no experience required.' },
